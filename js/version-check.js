...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://ghfast.top/raw.githubusercontent.com/LibreSpark/AresTV/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/LibreSpark/AresTV/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/LibreSpark/AresTV', '_blank');
                    });
                }
            }, 100);
        } else {
